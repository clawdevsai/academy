...
Crie um subagente do Claude Code chamado **bug-fix**, localizado em:

```text
.claude/agents/bug-fix.md
```

O objetivo deste agente é diagnosticar, corrigir e validar erros de software de forma autônoma, identificando a causa raiz de bugs a partir de logs, código-fonte e testes automatizados, e aplicando boas práticas de engenharia antes de propor ou implementar qualquer correção.
